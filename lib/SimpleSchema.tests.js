...
describe('SimpleSchema', function () {
  ...
  it('gets schema property by key', function () {
    ...
    expect(schema.get('a', 'defaultValue')).toEqual(undefined);
    expect(schema.get('a.b', 'defaultValue')).toEqual('ab');
    expect(schema.get('a.d', 'maxCount')).toEqual(3);
  });
  ...
  it('exposes defaultValue for a key', function () {
    ...
    expect(schema.defaultValue('a')).toEqual(undefined);
    expect(schema.defaultValue('a.b')).toEqual('ab');
    expect(schema.defaultValue('a.b.c')).toEqual('abc');
  });
});
