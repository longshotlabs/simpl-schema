...
describe('clean', function () {
  describe('normal doc', function () {
    ...
    it('when you clean a good blackbox object it is still good', getTest({blackBoxObject: myObj}, {blackBoxObject: myObj}, false));
  });
  ...
  describe('miscellaneous', function () {
    ...
    it('type convert to array', function () {
      ...
      ss.clean(myObj2, {isModifier: true});
    ...
    it('multi-dimensional arrays', function () {
      ...
      schema.clean(doc);
      expect(JSON.stringify(doc)).toEqual(expected);
    });
    ...
    it('remove null', function () {
      ...
      schema.clean(doc, { removeNullsFromArrays: true });
      expect(JSON.stringify(doc)).toEqual(expected);
    });
  ...
  describe('autoValue', function () {
    ...
    it('has correct information in function context - adds $set when missing', function () {
      ...
      const doc = {};
      schema.clean(doc, { isModifier: true });
      expect(doc).toEqual({
        $set: {
          bar: true,
        },
