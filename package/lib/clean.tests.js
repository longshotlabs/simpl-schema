...
describe('clean', function () {
  describe('normal doc', function () {
    ...
    it('when you clean an object with a length property, the length property should be removed', getTest(myObj3, { string: 't' }, false));

    const myObj4 = {
      string: 't',
      length: null,
    };
    it('when you clean an object with a length null, the length property should be removed', getTest(myObj4, { string: 't' }, false));
  });
  ...
  it('default value for sibling field added by $addToSet', function () {
    ...
    const cleanedModifier = schema.clean(accountsUpdateQuery, { isModifier: true });
